...
def start_action_callback(req):
    ...
    if name == "raise_bin":
        ...
        start_action_in_background(action_definitions.ActionRaiseFloor(data))
    elif name == "lower_floor":
        start_action_in_background(action_definitions.ActionLowerFloor(data))
    else:
